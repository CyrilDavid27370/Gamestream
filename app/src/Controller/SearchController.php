...
public function add(
    ...
    // 🔐 Vérifier si le user connecté a déjà ce jeu dans SA ludothèque
    ...
    // Tronquer le synopsis pour respecter la limite max 5000 caractères
    $overview = $data['description_raw'] ?? null;
    if ($overview && strlen($overview) > 5000) {
        $overview = substr($overview, 0, 4997) . '...';
    }
    ...
    // 🔐 Associer le jeu à l'utilisateur connecté
